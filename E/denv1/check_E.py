#!/usr/bin/env python3
"""
Verify and clean DENV1 E protein sequences.
"""
...
def verify_e_proteins(input_file, output_file):
    ...
    for record in records:
        ...
        if is_partial:
            ...
            if seq_len >= 495:  # Close to full length
...
def main():
    input_file = "DENV1_E_proteins_complete.fasta"
    output_file = "DENV1_E_proteins_verified.fasta"

    print("Verifying DENV1 E protein sequences...")
    print("=" * 50)
