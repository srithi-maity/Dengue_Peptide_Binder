...
def direct_protein_access(email):
    ...
    # Search for DENV4 envelope proteins
    search_term = '(dengue virus 4[Organism] OR DENV-4[All Fields]) AND ' \
                  '(envelope[Title] OR glycoprotein E[Title] OR E protein[Title])'

    print("Searching for DENV4 envelope proteins in NCBI Protein database...")
