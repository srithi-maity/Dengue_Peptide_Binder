#!/usr/bin/env python3
"""
Verify and clean DENV3 E protein sequences.
"""
...
def verify_e_proteins(input_file, output_file):
    ...
    for record in records:
        ...
        if is_partial:
            ...
            if seq_len >= 480:  # Close to full length (keeping it little low because , first I kept it as 495 , and I received only 6 sequences.)
...
def main():
    input_file = "DENV3_E_proteins_complete.fasta"
    output_file = "DENV3_E_proteins_verified.fasta"

    print("Verifying DENV3 E protein sequences...")
    print("=" * 50)
