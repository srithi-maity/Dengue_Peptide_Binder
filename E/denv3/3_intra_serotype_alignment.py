...
def main():
    input_file = "DENV3_E_proteins_verified.fasta"

    # Try different conservation thresholds
    thresholds = [100, 99, 98, 95, 90, 85, 80]

    print("=" * 80)
    print("FINDING HIGHLY CONSERVED REGIONS IN DENV3 E PROTEIN")
    print("=" * 80)
    ...
    if best_results:
        ...
        with open(f"conserved_regions_{best_threshold}percent.txt", "w") as f:
            f.write(f"DENV3 E PROTEIN - CONSERVED REGIONS (≥{best_threshold}% conservation)\n")
            f.write("=" * 80 + "\n\n")
